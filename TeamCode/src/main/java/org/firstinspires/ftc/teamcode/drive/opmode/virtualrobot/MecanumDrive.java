...
public class MecanumDrive {
    ...
    public static double TICKS_PER_ROTATION = 383.6;  // From NeveRest (for simulator)  GoBilda should be 383.6f
...
//    }
    ...
    protected void setSpeeds(double flSpeed, double frSpeed, double blSpeed, double brSpeed) {
...
//        double frontLeftSpeed = (forward + strafe + rotate)/2;
//        double frontRightSpeed = (forward - strafe - rotate)/2;
//        double backLeftSpeed = (forward - strafe + rotate)/2;
//        double backRightSpeed = (forward + strafe - rotate)/2;
