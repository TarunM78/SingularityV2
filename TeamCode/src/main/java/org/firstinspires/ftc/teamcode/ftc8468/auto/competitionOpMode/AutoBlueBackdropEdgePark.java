...
@Config
@Autonomous (name = "AutoBlueBackdropEdgePark")
public class AutoBlueBackdropEdgePark extends LinearOpMode {
    RRAutoDrive drive;
    String curAlliance = "blue";

    private TeamElementSubsystem teamElementDetection;

    private int liftMotorTicks = 1000;
...
//            telemetry.addData("Select Alliance (Gamepad1 X = Blue, Gamepad1 B = Red)", "");
        ...
        if (curAlliance == "blue") {
            ...
            trajSeqCenter = drive.trajectorySequenceBuilder(startPose)
                    ...
                    .lineTo(new Vector2d(50.5, 32), velConPixel, accConPixel)
