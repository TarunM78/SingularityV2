...
public class StackPipelineProcessor implements VisionProcessor, CameraStreamSource {
...
//    public volatile double correctionAmt = 0.0;
    ...
    public Object processFrame(Mat frame, long captureTimeNanos) {
        ...
        Mat hierarchy = new Mat(); // test if i can remove this
...
Imgproc.circle(frame2, new Point(closestPixelContour.x, closestPixelContour.y), 7, new Scalar(255, 0, 0), 5);
...
Imgproc.circle(frame2, new Point(closestTapeContour.x, closestTapeContour.y), 7, new Scalar(0, 0, 255), 5);
frame2.copyTo(frame);
frame2.copyTo(frame);
