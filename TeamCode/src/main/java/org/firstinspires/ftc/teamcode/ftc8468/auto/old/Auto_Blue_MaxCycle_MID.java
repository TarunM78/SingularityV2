...
@Disabled
@Autonomous
public class Auto_Blue_MaxCycle_MID extends LinearOpMode {
    RRAutoDrive drive;
    ...
    Trajectory traj1, traj2, traj3, traj1back,traj2back, traj4, traj5, traj6, traj7, traj8, traj9, traj10, traj11, traj12, traj13, traj14;
...
//                .splineToSplineHeading(new Pose2d(-10,-3, Math.toRadians(0)), Math.toRadians(90))
        ...
        traj3 = drive.trajectoryBuilder(nextPoseCycleAuto, true)
                ...
                .splineTo(new Vector2d(-14,0), Math.toRadians(-105))
...
//
        traj4 = drive.trajectoryBuilder(nextPoseCycleAuto)
                ...
                .splineToConstantHeading(
                        new Vector2d(36,28), Math.toRadians(0))
        ...
        traj5 = drive.trajectoryBuilder(nextPoseCycleAuto, true)
                ...
                .splineTo(new Vector2d(-15,11), Math.toRadians(-105))
        ...
        traj6 = drive.trajectoryBuilder(nextPoseCycleAuto)
                .splineTo(new Vector2d(-15,27), Math.toRadians(0))
                .addTemporalMarker(0, () -> {
                    drive.deactivateLift();
                    drive.deactivateDumpServo();
                    drive.startIntake(1.0);
                ...
                .splineToConstantHeading(
                        new Vector2d(40,38), Math.toRadians(0))
        ...
        traj8 = drive.trajectoryBuilder(nextPoseCycleAuto, true)
                ...
                .splineTo(new Vector2d(-16 ,20), Math.toRadians(-105))
        ...
        traj9 = drive.trajectoryBuilder(nextPoseCycleAuto)
                .splineTo(new Vector2d(-15,37), Math.toRadians(0))
                .addTemporalMarker(0, () -> {
                    drive.deactivateLift();
                    drive.deactivateDumpServo();
                    drive.startIntake(1.0);
                ...
                .splineToConstantHeading(
                        new Vector2d(42,48), Math.toRadians(0))
        ...
        traj11 = drive.trajectoryBuilder(nextPoseCycleAuto,true)
                ...
                .splineTo(new Vector2d(-14 ,32), Math.toRadians(-105))
        ...
        traj12 = drive.trajectoryBuilder(nextPoseCycleAuto)
                ...
                .splineToConstantHeading(
                        new Vector2d(35,58), Math.toRadians(0))
